...
class Twig_ExpressionParser
{
                ...
                switch ($token->getValue()) {
                    ...
                    default:
                        if ('(' === $this->parser->getCurrentToken()->getValue()) {
                            $node = $this->getFunctionNode($token->getValue(), $token->getLine(), $token->getCursor());
                        } else {
    ...
    public function getFunctionNode($name, $line, $cursor)
    {
        ...
        switch ($name) {
            ...
            default:
                ...
                return new $class($name, $args, $line, $cursor);
        }
    }
